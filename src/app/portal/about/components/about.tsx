  ...
  return (
    <>
      <div className="pr-8 pl-8 pt-14">
        <h1 className="sticky text-3xl pt-4 font-extrabold bg-gradient-to-r from-blue-600 via-indigo-500 to-purple-500 text-transparent bg-clip-text mb-6 text-center flex items-center justify-center gap-2">
          {user ? (
            <>
              <MdWavingHand
                size={28}
                className="text-yellow-500 animate-wave"
              />
      ...
      {message && (
        <div className="fixed top-32 left-1/2 transform -translate-x-1/2 bg-green-600 text-white px-4 py-2 rounded-lg shadow-lg animate-fadeInOut">
          {message}
        </div>
      )}
    </>
